...
@factory
class QuickNetXLFactory(ModelFactory):
    ...
    def spec(self) -> Tuple[Sequence[int], Sequence[int]]:
        spec = {34: ([6, 8, 12, 6], [64, 128, 256, 512])}
        try:
    ...
    def build(self) -> tf.keras.models.Model:
        ...
        model = tf.keras.Model(inputs=self.image_input, outputs=x, name="quicknet_xl")
